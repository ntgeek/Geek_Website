<template>
  <div  id="foremore">
    ...
    <li>1.什么是Geek(极客)？Geek精神又是什么？(暂定)</li>
      ...
      <div id="yinshen2" class="a" style="display: none">按照惯例，正式招新时间是在9月下旬~10月上旬，不过今年可能会有一些改动，地点一般在9号教学楼。
        如果想要了解加入我们，可以加入Q群，招新具体的安排/变动会在招新群
        通知的。</div>
      <BUTTON v-on:click="btn3()"><li>3.我们有考核吗？考核的流程是怎样的呀？</li></BUTTON><br>
      <div id="yinshen3" class="a" style="display: none">emmmm...考核还是比较严格的，不过别紧张hhh，开玩笑的啦~
        emmmm...考核还是比较严格的, 不过别紧张hhh, 开玩笑啦~
        我们一共有一轮笔试和两轮面试。
        第一轮笔试，考虑到有技术和经验尚缺但学习能力很强的新生，第一轮多是一些视野性的题目（这一轮选拔淘汰率并不高）。
        第二轮单独面试，话题包括根据你的笔试提出技术相关的问题、你的兴趣爱好、个人看法。
        最后一轮群面。首先问及时间分配上的问题（请避免时间冲突的情况），其次我们会向你提出各种稀奇古怪的问题。这一轮中许多题目其实并不难，也无标准答案，重在考察同学们在压力下的逻辑思维。
        全部通过就可以进入考核期成为预备成员啦。
      </div>
